...
\begin{figure}[htbp]
  \centerline{\includegraphics[width=120mm]{../fig/core_succ.eps}}
  \caption{最低次数とルーティング成功率}
  \label{fig:core_succ}
\end{figure}
