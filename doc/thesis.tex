...
\ \ 本研究では, 以上に挙げられたFreenetの問題点のうちルーティング効率性に着目する. 以下では現実のF2Fネットワーク構造をKleinbergモデルよりもさらに正確に反映し, かつgreedyルーティングが可能なモデルであるHyperbolic Space Model\cite{krioukov2010hyperbolic}を採用し, Sandbergのembedding生成手法を改良することにより, F2Fネットワークにおけるより分散ルーティングの効率性向上を目指す. 
